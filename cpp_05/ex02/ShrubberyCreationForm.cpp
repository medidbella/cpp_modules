...
ShrubberyCreationForm::ShrubberyCreationForm() : AForm("paper", 145, 137)
{
	target = "default";
	std::cout << "ShrubberyCreationForm default constructor is used\n";
}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string initTarget) : AForm("paper", 145, 137)
{
	target = initTarget;
	std::cout << "ShrubberyCreationForm constructor is used\n";
}

ShrubberyCreationForm::ShrubberyCreationForm(ShrubberyCreationForm &source) : AForm("paper", source.getSignGrade(),
