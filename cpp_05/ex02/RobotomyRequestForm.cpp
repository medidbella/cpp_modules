...
RobotomyRequestForm::RobotomyRequestForm() : AForm("paper", 72, 45)
{
	target = "default";
	std::cout << "RobotomyRequestForm default constructor is used\n";
}

RobotomyRequestForm::RobotomyRequestForm(const std::string initTarget) : AForm("paper", 72, 45)
{
	target = initTarget;
	std::cout << "RobotomyRequestForm constructor is used\n";
}

RobotomyRequestForm::RobotomyRequestForm(RobotomyRequestForm &source) : AForm("paper", source.getSignGrade(),
